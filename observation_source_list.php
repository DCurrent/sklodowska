<?php 
	...
	const LOCAL_STORED_PROC_NAME 	= 'stf_observation_source_list'; 	// Used to call stored procedures for the main record set of this script.
	const LOCAL_BASE_TITLE 			= 'Observation Items';	// Title display, button labels, instruction inserts, etc.
                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th><a href="<?php //echo $sorting->sort_url(1); ?>">Observation <?php //echo $sorting->sorting_markup(1); ?></a></th>             
                        </tr>
                    </thead>
                    <tfoot>
                    	<tr>
                            <th><a href="<?php echo $sorting->sort_url(2); ?>">Revision <?php echo $sorting->sorting_markup(2); ?></a></th>
                            <th><a href="<?php echo $sorting->sort_url(1); ?>">Label <?php echo $sorting->sorting_markup(1); ?></a></th>
                            <th><a href="<?php //echo $sorting->sort_url(1); ?>">Observation <?php //echo $sorting->sorting_markup(1); ?></a></th></tr>
                    </tfoot>
                    <tbody>                        
                        <?php
                            ...
                            ?>
                                        <tr class="clickable-row" role="button" data-href="<?php echo $_obj_data_main->get_id(); ?>">
                                            ...
                                            <td><?php echo $_obj_data_main->get_observation(); ?></td>
                                        </tr>                                    
                            <?php								
                            	}
							}
