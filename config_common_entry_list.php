<?php 
	...
	const LOCAL_BASE_TITLE 			= 'Common Form';	// Title display, button labels, instruction inserts, etc.
	$primary_data_class				= '\dc\application\CommonEntry';
	...
	class class_filter_control
	{
		...
		public function __construct()
		{
			...
			$this->time_obj = new \dc\chronofix\Chronofix();	
		}
